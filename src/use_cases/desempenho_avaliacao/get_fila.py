...
class GetFilaUsuarioUseCase:
    """Quem `usuario_id` ainda precisa avaliar, olhando só os lotes abertos
    cujo projeto ele integra hoje (regra 2.3). Reaproveitada tanto pelo
    endpoint de fila do próprio usuário quanto para calcular a
    `proxima_pendencia` depois de submeter uma avaliação (regra 2.4)."""
